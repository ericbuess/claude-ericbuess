...
SESSION_CACHE="$REPO_ROOT/session-data/cache/session-status-ultra.json"
...
if [ -n "$MODEL_DISPLAY" ]; then
    echo -e "${MODEL_DISPLAY} ${USER_HOST_DIR}${PROJECT_TYPE}${MEMORY_STATUS} | ${SESSION_INFO}${TIME_INFO}${TOKEN_INFO}${VERSE_INFO}${GIT_INFO}"
else
    echo -e "${USER_HOST_DIR}${PROJECT_TYPE}${MEMORY_STATUS} | ${SESSION_INFO}${TIME_INFO}${TOKEN_INFO}${VERSE_INFO}${GIT_INFO}"
fi

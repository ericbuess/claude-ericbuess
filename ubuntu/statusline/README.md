...
1. Script is at: `~/Projects/claude-ericbuess/ubuntu/statusline/scripts/statusline.sh`
2. Configured in `~/.claude/settings.json`:
```json
"statusLine": {
  "type": "command", 
  "command": "/home/ericbuess/Projects/claude-ericbuess/ubuntu/statusline/scripts/statusline.sh"
}
```
